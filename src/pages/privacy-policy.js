    ...
    <TemplateWrapper>
      <div className="container">
        <div className="content">
          <h1 className="has-text-weight-semibold is-size-3">Privacy Policy</h1>
          <h2 className="has-text-weight-semibold">
            Last updated on Jan 16th 2024
          </h2>
          <p>
            This privacy policy sets out how LEENAS MUSHROOM FARMS LLP uses and
            protects any information that you give LEENAS MUSHROOM FARMS LLP
            when you use this website.
          </p>
          <p>
            LEENAS MUSHROOM FARMS LLP is committed to ensuring that your privacy
          ...
          <p>
            LEENAS MUSHROOM FARMS LLP may change this policy from time to time
          ...
          <h5>
            Disclaimer: The above content is created at LEENAS MUSHROOM FARMS
            LLP's sole discretion. Razorpay shall not be liable for any content
